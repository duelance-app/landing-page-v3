                    ...
                    <div className="max-w-sm mx-auto grid gap-6 md:grid-cols-2 lg:grid-cols-2 items-start md:max-w-2xl lg:max-w-none">
                        ...
                        <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-md">
                            ...
                            <p className="text-gray-600 text-center">
                                It doesn’t matter if it’s a $20 job or a $200K
                                one. Pay a fixed monthly price and hire as many
                                freelancers as you want to. It’s 5-10x cheaper
                                for you.
                            </p>
                        </div>
                        ...
                        <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-md">
                            ...
                            <p className="text-gray-600 text-center">
                                Stop spending days gathering resumes, scanning
                                through them, setting up interviews, and finally
                                starting work. Our platform does all the heavy
                                lifting, enabling you to start with a suitable
                                person within hours.
                            </p>
                        </div>
                        ...
                        <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-md">
                            ...
                            <p className="text-gray-600 text-center">
                                For one off projects (development, writing &
                                editing, graphic design), we show you
                                submissions from a few curated freelancers to
                                help you compare and choose the best one.
                            </p>
                        </div>
                        ...
                        <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-md">
                            ...
                            <p className="text-gray-600 text-center">
                                Duelance handles everything for you. Everything
                                from finding candidates to paying them. All you
                                need to do is give us what you need done.
                            </p>
                        </div>
                    </div>
                </div>
